    ...
    */
                       ...
                       const W & default_w, Results & results, int advance) const
    {
        ...
        */
        ...
        float Zval = results.add(feature, w, 0.5, missing);
        results.finish(feature);
                        ...
                        int advance) const
    {
        ...
        if (!results.start(feature, w, missing)) return Z::worst;
        float Zval = results.add_presence(feature, w, 0.5, missing);
        results.finish(feature);
                           ...
                           int advance) const
    {
        ...
        */
        ...
        if (i != 0) {
            Zval = results.add(feature, w, -INFINITY, missing);
        
            if (debug)
                cerr << "added split " << -INFINITY << " with " << missing
                     << " missing and score " << Zval << endl;
        }
                       ...
                       int advance) const
    {
        ...
        if (debug) {
            ...
            cerr << "added default split " << -INFINITY << " with "
                 << missing << " missing and score " << Zval
                 << endl;
        }
