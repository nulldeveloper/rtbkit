...
#CXXNODEBUGFLAGS := -O3 -DBOOST_DISABLE_ASSERTS -DNDEBUG   # Production-mode optimization
CXXNODEBUGFLAGS ?= -O3 -DBOOST_DISABLE_ASSERTS -DNDEBUG # Debug mode optimization
